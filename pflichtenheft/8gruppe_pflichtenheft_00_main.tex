...
\begin{document}
\pagestyle{empty}
\include{8gruppe_pflichtenheft_00_deckblatt}
\tableofcontents
\newpage
\pagestyle{fancy}
\setcounter{page}{1}

\include{8gruppe_pflichtenheft_00_kapitel}
% Anforderungsbeschreibung
%\include{8gruppe_pflichtenheft_01}
% Produkteinsatz
%\include{8gruppe_pflichtenheft_02}
% Produktumgebung
%\include{8gruppe_pflichtenheft_03}
% Produktfunktionen
%\include{8gruppe_pflichtenheft_04}
% Produktdaten
%\include{8gruppe_pflichtenheft_05}
% Produktleistungen
%\include{8gruppe_pflichtenheft_06}
% Qualitaetsbestimmung
%\include{8gruppe_pflichtenheft_07}
% Globale Testfaelle
%\include{8gruppe_pflichtenheft_08}
% Ergaenzungen
%\include{8gruppe_pflichtenheft_09}
