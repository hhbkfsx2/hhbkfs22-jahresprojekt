...
\begin{document}
\pagestyle{empty}
\include{2jahr_jahresprojekt_00_deckblatt}
\tableofcontents
\newpage
\pagestyle{fancy}
\setcounter{page}{1}

%\include{2jahr_jahresprojekt_01_kapitel1}
%\include{2jahr_jahresprojekt_02_kapitel2}
%\include{2jahr_jahresprojekt_03_kapitel3}
%\include{2jahr_jahresprojekt_04_kapitel4}
