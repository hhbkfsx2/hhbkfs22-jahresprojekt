...
Es wurde ein virtueller Windows Client im Internen Netz eingerichtet um die Dienste des Domänen-Kontorollers zu überprüfen.   

Tests:
1. Test-User anlegen.
2. Client in die Domäne hinzufügen.
3. Mit dem Test-User sich am Client anmelden. 
4. Den Server per VPN erreichen.
...
Die Tests waren alle erfolgreich, womit bewiesen wurde, das alle geforderten Dienste des Servers im interen IPv6-Netz funktionieren. 